...
decomp_multi_NN5_32<-decomp(NN5_32,decomposition = "multiplicative", outplot = TRUE)
...
es_NN5_32_h
es_NN5_12_h$accuracy # MAPE accuracy is 38.6%. 
...
legend("topleft",c("test data NN5_32","Forecast from ARIMA model"),fill=c("blue","red" ))
#Extract Residuals
...
legend("topleft",c("Train data NN5_32","Test data NN5_32","Forecast from regression model", "Fitted values"),fill=c("black","red","blue","purple" ))
